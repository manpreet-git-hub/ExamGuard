...
# source /Users/manpreet/Downloads/ai_env/bin/activate
#

# source /Users/manpreet/Downloads/ai_env/bin/activate

# FRONTEND
# cd /Users/manpreet/Downloads/exam_platform/frontend
# npm install
# npm run dev

# Terminal 1 — Backend:
# bashsource /Users/manpreet/Downloads/ai_proctoring_system/ai_env/bin/activate
# cd /Users/manpreet/Downloads/exam_platform/backend
# pip install "python-jose[cryptography]" "passlib[bcrypt]" "bcrypt==4.0.1" fastapi "uvicorn[standard]" sqlalchemy python-multipart pydantic aiosqlite websockets
# python seed.py
